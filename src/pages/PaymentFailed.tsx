          ...
          <div className="text-center">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                  to="/contact"
                  className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Contact Support
                </Link>
              </div>
